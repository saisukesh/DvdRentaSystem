<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmSellerLogin.aspx.cs" Inherits="frmSellerLogin" Title="Seller Login" %>
        ...
        <table class="style6">
            ...
            <tr>
                <td class="style8" colspan="2">
                    If you are a New Seller please
                    <asp:LinkButton ID="LinkButton1" runat="server" 
                        PostBackUrl="~/frmSellerRegistration.aspx">Sign Up</asp:LinkButton>
                    &nbsp;Here</td>
            </tr>
            <tr>
                <td class="style8" colspan="2">
